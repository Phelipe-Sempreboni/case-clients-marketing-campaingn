...
SELECT 
      SUM([MNT_MEAT_PRODUCTS]) AS [MNT_MEAT_PRODUCTS]
     ,
     CASE
...
SELECT 
      SUM([MNT_FISH_PRODUCTS]) AS [MNT_FISH_PRODUCTS]
     ,
     CASE
...
SELECT 
      SUM([MNT_SWEET_PRODUCTS]) AS [MNT_SWEET_PRODUCTS]  
      ,
      CASE
...
SELECT 
      SUM([MNT_GOLD_PRODS]) AS [MNT_GOLD_PRODS]
      ,
      CASE
...
SELECT * FROM [TBL_SUM_PRODUCTS] ORDER BY [NUMBERS_PRODUCTS];
