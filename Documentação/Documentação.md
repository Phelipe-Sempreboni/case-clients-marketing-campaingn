...
SELECT 
      [NUMBER_CLIENTS]
     ,[MARITAL_STATUS]
     ,([NUMBER_CLIENTS] * 100)/(@NUMBER_CLIENTS) AS [PERCENT_CLIENTS_MARITAL_STATUS]
     ,[AVG_YEARS_OLD]
     ,[AVG_MONTHLY_INCOME]
     ,[AVG_INCOME]
     ,[SUM_KIDHOME]
...
SELECT 
      [NUMBER_CLIENTS]
     ,[KIDHOME]
     ,([NUMBER_CLIENTS] * 100)/(@NUMBER_CLIENTS) AS [PERCENT_CLIENTS_KIDHOME]
     ,[AVG_YEARS_OLD]
     ,[AVG_MONTHLY_INCOME]
     ,[AVG_INCOME]
     ,[SUM_KIDHOME]
...
SELECT 
      [NUMBER_CLIENTS]
     ,[TEENHOME]
     ,([NUMBER_CLIENTS] * 100)/(@NUMBER_CLIENTS) AS [PERCENT_CLIENTS_TEENHOME]
     ,[AVG_YEARS_OLD]
     ,[AVG_MONTHLY_INCOME]
     ,[AVG_INCOME]
     ,[SUM_KIDHOME]
